<div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    ...
                    <a href="<?php echo base_url('keuangan/tampilinfaq')?>">Kembali</a>
                    </h4></div>
            ...
            <form action="<?php echo base_url(). 'keuangan/prosestambahdatainfaq'; ?>" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="nominal_bayar_infaq" name="nominal_bayar_infaq" placeholder="Masukan Jumlah">
</div>
